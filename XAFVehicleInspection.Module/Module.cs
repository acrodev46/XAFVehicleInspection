...
using XAFVehicleInspection.Module.Reports;

namespace XAFVehicleInspection.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XAFVehicleInspectionModule : ModuleBase {
    public XAFVehicleInspectionModule() {
		// 
		// XAFVehicleInspectionModule
		// 
    ...
    public override IEnumerable<ModuleUpdater> GetModuleUpdaters(IObjectSpace objectSpace, Version versionFromDB) {
        ...
        predefinedReportsUpdater.AddPredefinedReport<Report>("Inspection", typeof(Vehicle), true);
