...
namespace XAFVehicleInspection.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater
{
    ...
    public override void UpdateDatabaseAfterUpdateSchema()
    {
        ...
        Vehicle vehicle1 = ObjectSpace.FirstOrDefault<Vehicle>(vehicle => vehicle.Vin == "12345");
        if (vehicle1 == null)
        {
            vehicle1 = ObjectSpace.CreateObject<Vehicle>();
            vehicle1.Vin = "12345";
            vehicle1.Model = "Tesla Model 3";
        }
        Vehicle vehicle2 = ObjectSpace.FirstOrDefault<Vehicle>(vehicle => vehicle.Vin == "988774");
        if (vehicle2 == null)
        {
            vehicle2 = ObjectSpace.CreateObject<Vehicle>();
            vehicle2.Vin = "988774";
            vehicle2.Model = "Porsche ZZ";
        }
